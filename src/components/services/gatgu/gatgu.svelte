...
<ProjectWrapper class="project-gatgu-wrapper" id={'gatgu'}>
  <Overview
    logo={'../../../images/gatgu.png'}
    name={'같이구매'}
...
<style>
  :global(.project-gatgu-wrapper) {
    background: radial-gradient(35.89% 41.81% at 50% 53.89%, #ffffff 0%, #ffdc48 100%);
    border: 25px solid #274e8c;
